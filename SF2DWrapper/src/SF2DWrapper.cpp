/// <summary> The main DLL file </summary> 
...
SF3D::SFRotationDegreeSet SFSimulator::getRotationDegreeSet()
{
	...
	SF3D::SFRotationDegreeSet result = 
		SF3D::SFRotationDegreeSet(s.getRotationOX(), s.getRotationOY(), s.getRotationOZ(), SF3D::SFVector3(c.x(), c.y(), c.z()));
